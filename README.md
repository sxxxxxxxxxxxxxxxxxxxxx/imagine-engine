...
基于 **Nano Banana AI** (Google Gemini 2.5 Flash) 的专业图像创作平台

> 采用世界顶级的 Nano Banana AI 模型，提供专业级图像生成和编辑能力

## 🌟 Nano Banana AI 核心特性

### 🍌 什么是 Nano Banana？

Nano Banana 是 Google Gemini 2.5 Flash Image 模型的官方名称，代表世界顶尖的 AI 图像生成技术：

- ✅ **角色一致性**：完美保持人物、宠物在不同图像中的一致外观
- ✅ **场景融合**：多张图像无缝融合，创造统一视觉效果
- ✅ **批量生成**：一次生成多张变体，快速选择最佳效果
- ✅ **自然语言控制**：用中文描述即可精确控制图像生成
- ✅ **专业级输出**：适合商业使用的高质量图像
- ✅ **SynthID 水印**：AI 生成内容透明标识

## ✨ 核心功能

### 🎨 AI 创作 (文生图)
- **批量生成**：一次创建 1-4 张变体，快速对比选择 ⭐ 新增
- **智能提示词**：支持中文描述，AI 自动优化提示词
- **6种艺术风格**：超写实、动漫、油画、水彩、赛博朋克、极简
- **灵活比例**：支持 1:1、16:9、9:16、4:3、3:4 多种尺寸
- **参考图引导**：上传参考图，保持风格一致性
- **提示词库**：内置 72+ 精选模板，一键应用
- **快捷键操作**：Ctrl+Enter 快速生成，提升效率
- **作品集管理**：自动保存历史，支持下载和继续编辑
