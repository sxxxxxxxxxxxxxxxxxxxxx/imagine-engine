          ...
          <div className="space-y-6">
            ...
            <div className="card p-6 bg-primary-50 dark:bg-primary-950/30">
              <h4 className="font-semibold text-dark-900 dark:text-dark-50 mb-3 flex items-center gap-2">
                ...
                {language === 'zh' ? '增强内容' : 'Enhancement Features'}
              </h4>
          ...
          <div>
            ...
            <div className="card p-6 bg-dark-50 dark:bg-dark-800 mt-6">
              ...
              <ul className="space-y-2 text-sm text-dark-700 dark:text-dark-300">
                <li className="flex items-start gap-2">
                  <span className="text-primary-500">✓</span>
                  <span>{language === 'zh' ? '修复模糊或低分辨率照片' : 'Fix blurry or low-resolution photos'}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary-500">✓</span>
                  <span>{language === 'zh' ? '优化手机拍摄的照片' : 'Optimize mobile phone photos'}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary-500">✓</span>
                  <span>{language === 'zh' ? '提升老照片质量' : 'Enhance old photo quality'}</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary-500">✓</span>
                  <span>{language === 'zh' ? '优化网络下载的图片' : 'Optimize downloaded images'}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        {!isLoggedIn && (
          <div className="card p-8 bg-primary-500 text-white text-center mt-12">
            <h3 className="text-2xl font-bold mb-3">
              {language === 'zh' ? '免费体验画质增强' : 'Try Quality Enhancement Free'}
            </h3>
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              {language === 'zh' 
                ? '注册即送20张免费额度！升级Basic版本，200张配额每月，包含画质增强、去背景等8+工具！'
                : 'Sign up for 20 free images! Upgrade to Basic: 200 quota/month, includes enhancement, remove bg & 8+ tools!'}
            </p>
