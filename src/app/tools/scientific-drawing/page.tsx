        ...
        {!isLoggedIn && (
          <div className="card p-8 bg-primary-500 text-white text-center mt-12">
            <h3 className="text-2xl font-bold mb-3">
              {language === 'zh' ? '免费体验科研绘图' : 'Try Scientific Drawing Free'}
            </h3>
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              {language === 'zh' 
                ? '注册即送20张免费额度！升级Basic版本，200张配额每月，包含科研绘图、去背景等8+工具！'
                : 'Sign up for 20 free images! Upgrade to Basic: 200 quota/month, includes scientific drawing, remove bg & 8+ tools!'}
            </p>
